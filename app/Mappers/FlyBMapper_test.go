...
func BenchmarkFlyBMapper_MapToTransactionEntity(b *testing.B) {
	...
	var flyAEntity = Entities.FlyPayBEntity{Transactions: flyBTransactions}
	flyBRepository.On("GetFlyBEntity").Return(&flyAEntity, nil)
